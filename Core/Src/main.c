...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, CS_EEPROM_Pin|CS2_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : CS_EEPROM_Pin CS2_Pin */
  GPIO_InitStruct.Pin = CS_EEPROM_Pin|CS2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : CS1_Pin RST1_Pin RST2_Pin */
  GPIO_InitStruct.Pin = CS1_Pin|RST1_Pin|RST2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
